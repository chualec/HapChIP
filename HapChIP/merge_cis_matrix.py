...
def parse_hichip(infiles, outfiles):
  pdmatrix = pd.DataFrame(0,columns = ['HC-9', "HC-10", "HC-12", "HC-13", "HC-21", "HC-25"], index = ['Sum'])
  standard = ["chr1",  "chr2",  "chr3",  "chr4",  "chr5",  "chr6",  "chr7",  "chr8",  "chr9",  "chr10",  "chr11",  "chr12",  "chr13",  "chr14",  "chr15",  "chr16",  "chr17",  "chr18",  "chr19",  "chr20",  "chr21",  "chr22",  "chrX",  "chrY"]
  print(pdmatrix)
...
def main(options):
  ...
  #load in input files
  hc9 = open("/mctp/share/users/chualec/hichip/vif/files/HC-9/cis_trans_split/HC-9.pairs.trans.round.txt", "r")
  hc10 = open("/mctp/share/users/chualec/hichip/vif/files/HC-10/cis_trans_split/HC-10.pairs.trans.round.txt", "r")
  hc12 = open("/mctp/share/users/chualec/hichip/vif/files/HC-12/cis_trans_split/HC-12.pairs.trans.round.txt", "r")
  hc13 = open("/mctp/share/users/chualec/hichip/vif/files/HC-13/cis_trans_split/HC-13.pairs.trans.round.txt", "r")
  hc21 = open("/mctp/share/users/chualec/hichip/vif/files/HC-21/cis_trans_split/HC-21.pairs.trans.round.txt", "r")
  hc25 = open("/mctp/share/users/chualec/hichip/vif/files/HC-25/cis_trans_split/HC-25.pairs.trans.round.txt", "r")
  infiles = [hc9, hc10, hc12, hc13, hc21, hc25]
  
  outfile = "/mctp/share/users/chualec/hichip/vif/files/trans.all.bins.filtered.matrix"
